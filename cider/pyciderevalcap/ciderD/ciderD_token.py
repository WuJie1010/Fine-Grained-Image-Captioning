...
from ciderD_scorer_token4 import CiderScorer
import pdb
...
class CiderD:
    ...
    def compute_score(self, gts, res, loader):
        """
        ...
        (score, log_score, token_scores) = self.cider_scorer.compute_score(loader)

        return score, log_score, token_scores
