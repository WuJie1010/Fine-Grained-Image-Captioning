...
def parse_opt():
    ...
    parser.add_argument('--CNN', type=str, default='Resnet101',
                    help='CNN features Resnet152 Resnet101')
    parser.add_argument('--datasets', type=str,  default='mscoco',
                    help='mscoco, flickr30k')
    parser.add_argument('--input_label_h5', type=str, default='data/mscoco_knnlabel.h5',
                    help='path to the h5file containing the preprocessed dataset  data/flickr30ktalk_label.h5')
    ...
    parser.add_argument('--batt_hid_size', type=int, default=512,
                    help='the hidden size of the attention MLP; only useful in show_attend_tell; 0 if not using hidden layer')
    parser.add_argument('--fc_feat_size', type=int, default=2048,
                    help='2048 for resnet101')
    parser.add_argument('--att_feat_size', type=int, default=2048,
                    help='2048 for resnet101')
    parser.add_argument('--batt_feat_size', type=int, default=2048,
                    help='2048 for resnet101')
    ...
    parser.add_argument('--scheduled_sampling_start', type=int, default=5, 
