...
def parse_opt():
    ...
    parser.add_argument('--input_json', type=str, default='data/cocotalk.json',
                    help='path to the json file containing additional info and vocab  data/flickr30ktalk.json ')
    ...
    parser.add_argument('--self_critical_start', type=int, default=0,
                    help='After what iter do we start self_critical training ? (-1 = dont start ; >=0:that epoch )')
    ...
    parser.add_argument('--hdr_w', type=float, default=1.0,
                    help='HDR weight factor')
    parser.add_argument('--bdr_w', type=float, default=1.0,
                    help='BDR weight factor')
    ...
    parser.add_argument('--num_gru', default=1, type=int,
